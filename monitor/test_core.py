...
class TestOpenSnitchCrossReference(unittest.TestCase):
    ...
    def test_detection_confirmed_by_opensnitch(self, mock_iptables: MagicMock, mock_logger: MagicMock) -> None:
    ...
    @patch("monitor.core.logger")
    @patch("monitor.core.IptablesManager.add_drop_rule")
    def test_detection_not_confirmed_by_opensnitch(self, mock_iptables: MagicMock, mock_logger: MagicMock) -> None:
...
class TestDNSRegexParsing(unittest.TestCase):
    ...
    def test_parse_reply_format(self) -> None:
    ...
    def test_parse_cached_format(self) -> None:
    ...
    def test_ignore_query_lines(self) -> None:
...
class TestTimestampParsing(unittest.TestCase):
    ...
    def test_timestamp_measures_actual_event_age(self) -> None:
...
class TestGracePeriodTiming(unittest.TestCase):
    ...
    @patch("monitor.core.logger")
    def test_connection_not_checked_before_grace_period(self, mock_logger: MagicMock) -> None:
    ...
    def test_connection_checked_after_grace_period(self) -> None:
    ...
    def test_grace_period_handles_dns_lag(self) -> None:
    ...
    def test_grace_period_value_is_three_seconds(self) -> None:
        """Verify grace period constant is set to 3 seconds"""
        # This test ensures the fix is in place
        self.assertEqual(
            CONNECTION_GRACE_PERIOD, 3.0, "Grace period should be 3 seconds to handle docker log buffering"
        )
