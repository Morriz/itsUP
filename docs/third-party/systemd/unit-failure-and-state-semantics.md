...
- **A unit hooked to alert about its own failure has no outer observer.** A handler
  unit declares no `OnFailure=` of its own. Its failures are found in the journal
  rather than announced. Its silence is indistinguishable from health.
