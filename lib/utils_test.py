...
class TestStreamOutput(unittest.TestCase):
    ...
    @mock.patch("subprocess.Popen")
    @mock.patch("sys.stdout.buffer.write")
    def test_handles_stdout_stream(self, mock_write: Mock, mock_popen: Mock):
        process = mock_popen.return_value
        process.stdout.read.side_effect = [b"output1", b"output2", b""]
...
class TestRunCommand(unittest.TestCase):
    ...
    @mock.patch("subprocess.Popen")
    def test_runs_command_no_errors(self, mock_popen: Mock, _):
    ...
    @mock.patch("subprocess.Popen")
    def test_runs_host_command(
        self, mock_popen: Mock, mock_path_exists: Mock, mock_run_host_command: Mock
    ):
